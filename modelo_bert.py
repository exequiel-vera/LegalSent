...
# Cargar el modelo BERT entrenado y el tokenizer correspondiente

model = TFSMLayer('modelo/bert_model.h5', call_endpoint='serving_default')
...
for pdf_file in pdf_files:
    ...
    for sentence in sentences:
        ...
        result = classify_sentence(short_sentence)
